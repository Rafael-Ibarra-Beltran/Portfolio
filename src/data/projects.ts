export const projects = [
  {
    ...
    links: [{ label: 'Launch', href: 'https://axocred-demo.vercel.app/' }]
  },
  {
    title: 'LegisConnect',
    ...
    links: [{ label: 'Launch', href: 'https://legis-connect.vercel.app/' }]
  },
  {
    title: 'SummaryQ',
    description: {
    ...
    links: [
      { label: 'Demo', href: 'https://rib-summaryq.vercel.app' },
      { label: 'GitHub', href: 'https://github.com/Rafael-Ibarra-Beltran/SummaryQ' }
    ]
  },
  {
    title: 'LibreStock',
